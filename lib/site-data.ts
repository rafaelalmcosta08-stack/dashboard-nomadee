...
export const units: Unit[] = [
  {
    sigla: 'RPM',
    nome: 'Rádio Patrulha Militar',
    descricao:
      'Responsável pelo policiamento ostensivo e preservação da ordem pública. Atua na prevenção e repressão imediata de crimes.',
    icon: Shield,
    image: 'https://res.cloudinary.com/epo1w9hl/image/upload/v1785633848/007_hhigpm.png',
  },
  {
    sigla: 'CHOQUE',
    nome: 'Controle de Tumultos',
    descricao:
  ...
  },
  {
    ...
    icon: Target,
    image: 'https://res.cloudinary.com/epo1w9hl/image/upload/v1785633848/011_yp0ecw.png',
  },
  {
    sigla: 'GRR',
    ...
    icon: Zap,
    image: 'https://res.cloudinary.com/epo1w9hl/image/upload/v1785633848/image_ilbexh.png',
  },
  {
    sigla: 'ROCAM',
    nome: 'Rondas Ostensivas com Apoio de Motocicletas',
    descricao:
    ...
    icon: Bike,
    image: 'https://res.cloudinary.com/epo1w9hl/image/upload/v1785633848/009_ngdcgt.png',
  },
  {
    sigla: 'GRAER',
    nome: 'Grupamento de Radiopatrulhamento Aéreo',
    descricao:
    ...
    icon: Plane,
    image: 'https://res.cloudinary.com/epo1w9hl/image/upload/v1785633848/010_bbcq2n.png',
  },
  {
    sigla: 'DPJM',
    nome: 'Departamento de Polícia Jurídico Militar',
    descricao:
